...
const ProfileFeed = (props: { userId: string }) => {
  ...
  if (isLoading)
    return (
      <div className="relative h-[35vh] sm:h-[75vh]">
  ...
  return (
    <>
      ...
      <PageLayout>
        ...
        <div className="mt-[50px] rounded-lg pb-4 shadow-xl">
          <div className="relative h-32 sm:h-36">
            ...
            <div className="sm: absolute top-20 ml-4">
              <div className="absolute relative right-0  h-24 w-24 sm:h-32 sm:w-32">
                <Image
                  src={data.image ?? ""}
                  alt={`@${data.username ?? ""}' profil picture`}
                  fill
                  className="rounded-full border-4 border-slate-900"
                  sizes="(max-width: 768px) 96px, (min-width: 768px) 128px"
                />
              </div>
            </div>
          </div>
          <div className=" ml-4 flex flex-col">
            ...
            <div className="mt-4  max-h-[200px] items-center">
